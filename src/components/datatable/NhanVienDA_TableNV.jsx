...
const Nhanvien_DuAn_Table = (props) =>
{
    ...
    useEffect(async () =>
    {
        ...
        const result = await axios(
            `http://localhost:8080/api/nhanvienduan/them/${props.duAnId}`);
        ...
        console.log("Danh sách nhân viên: ",rowData );
...
export default Nhanvien_DuAn_Table;